...
export const CLASSES: Record<string, ClassDefInput> = {
  ...
  necromancer: {
    name: 'Necromancer', color: '#55cc88', glow: '#228844',
    desc: 'Master of undead. Commands skeletons via Death Marks; drains life to fuel the army.',
    hp: 7, moveSpeed: 180, maxMana: 100, manaRegen: 14,
    passive: { name: 'Bone Collector', desc: 'Kills heal you 0.5 HP and the nearest skeleton 1 HP.' },
    spells: [
  ...
  ranger: {
    ...
    desc: 'Ranged DPS. Fast charged shots, evasive rolls for safety.',
    hp: 6, moveSpeed: 210, maxMana: 90, manaRegen: 14,
  ...
  bladecaller: {
    ...
    desc: 'Vampiric fencer. Stealth, backstab bursts, lifesteal sustain.',
    ...
    spells: [
      ...
      { name: 'Shadow Step', key: 'RMB', type: SpellType.Leap, range: 140, mana: 12, cd: 3, dmg: 14, aoeR: 0, color: '#aa2244', targetLock: true },
