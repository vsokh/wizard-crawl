...
export const ENEMIES: Record<string, EnemyDef> = {
  ...
  bomber: { name: 'Bomber', hp: 4, speed: 45, size: 12, color: '#cc6622', dmg: 1, xp: 3, gold: 2, ai: EnemyAI.Chase, atkR: 20, atkCd: 1.2, explodeOnDeath: 60 },
  teleporter: { name: 'Teleporter', hp: 3, speed: 70, size: 9, color: '#aa33cc', dmg: 2, xp: 4, gold: 3, ai: EnemyAI.Chase, atkR: 18, atkCd: 0.9, teleport: true },
  splitter: { name: 'Splitter', hp: 5, speed: 60, size: 13, color: '#448844', dmg: 1, xp: 2, gold: 2, ai: EnemyAI.Chase, atkR: 22, atkCd: 1.0, splitInto: 'splitling' },
  splitling: { name: 'Splitling', hp: 1, speed: 110, size: 7, color: '#66aa66', dmg: 1, xp: 1, gold: 0, ai: EnemyAI.Chase, atkR: 14, atkCd: 0.5 },
  berserker: { name: 'Berserker', hp: 6, speed: 50, size: 11, color: '#cc2222', dmg: 3, xp: 4, gold: 4, ai: EnemyAI.Chase, atkR: 22, atkCd: 1.0, enrage: true },
};
